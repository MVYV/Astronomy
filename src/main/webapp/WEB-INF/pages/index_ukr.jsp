...
<html>
<head>
    <title>Астрономія | Astronomy-mvyv.rhcloud.com</title>
        ...
        <table id="glassTable" border="0" style="font-family: Verdana;">
            <tr>
                ...
                <sec:authorize access="hasAnyRole('ROLE_USER', 'ROLE_ADMIN')">
                    <th class="glassLink"><a href="/j_spring_security_logout">Вийти</a></th>
                </sec:authorize>
            </tr>
        </table>
    </div>
    ...
    <div><a href="#close" title="Close" class="close">X</a>
        <form id="contact_form" action="<c:url value='/j_spring_security_check' />" method="post">																												<!-- ╨д╨╛╤А╨╝╨░ ╨░╨▓╤В╨╛╤А╨╕╨╖╨░╤Ж╤Ц╤Ч -->
            <table width="400" border="0">																															<!-- ╨в╨░╨▒╨╗╨╕╤Ж╤П ╨┤╨╗╤П ╤А╨╛╨╖╨╝╤Ц╤Й╨╡╨╜╨╜╤П ╨╡╨╗. ╤Д╨╛╤А╨╝╨╕ -->
                <tr>																																				<!-- ╨а╤П╨┤╨╛╨║ -->
                    <td>
                        <input type="text" id="j_username" name="j_username" placeholder="Будь-ласка введіть ваш логін:" value="" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="password" id="j_password" name="j_password" placeholder="Будь-ласка введіть ваш пароль:" value="" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <a href="/authorization" id="authorization_link">Зареєструватися</a>
                    </td>
                </tr>
            </table>
        </form>
